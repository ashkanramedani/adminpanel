...
export class SalaryPolicyAddComponent implements OnInit {
    ...
    this.ReportForm = this.formBuilder.group(
      {
        ...
        overtime_permission: new FormControl(''),
        overtime_factor: new FormControl(''),
        overtime_cap: new FormControl(''),
        overtime_threshold: new FormControl(''),
        undertime_factor: new FormControl(''),
        undertime_threshold: new FormControl(''),
        off_day_permission: new FormControl(''),
        off_day_factor: new FormControl(''),
        off_day_cap: new FormControl(''),
        remote_permission: new FormControl(''),
        remote_factor: new FormControl(''),
        remote_cap: new FormControl(''),
        medical_leave_factor: new FormControl(''),
        medical_leave_cap: new FormControl(''),
        vacation_leave_factor: new FormControl(''),
        vacation_leave_cap: new FormControl(''),
        business_trip_permission: new FormControl(''),
        business_trip_factor: new FormControl(''),
        business_trip_cap: new FormControl('')
      }
    )
    if (this.id != null) {
  ...
  get_single_Data() {
    this.http
      .get(Domain.GetSalaryPolicyData, this.id)
      .subscribe((response) => {
  ...
  onSubmit() {
    ...
    if (this.id != null) {
      ...
      this.http.put(Domain.PutSalaryPolicyData, ReportFormValue, null).subscribe((response) => {
        console.log(response)
      ...
      this.btnLoading = true
      this.http.create(Domain.CreateSalaryPolicyData, ReportFormValue, null).subscribe((response) => {
        console.log(response)
