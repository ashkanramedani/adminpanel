...
export const Domain =
{
    ...
    "GetSingleClassCancellation": `${environment.apiUrl}/api/v1/form/class_cancellation/search`,
    "PutClassCancellation": `${environment.apiUrl}/api/v1/form/class_cancellation/update`,
